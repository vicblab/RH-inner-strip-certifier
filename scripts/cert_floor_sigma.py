...
def main():
    ...
    cov={'sector':'floor','method':'half_open_floor_sector_identically_zero'}; norm={'sector':'floor','side':'zero'}
    out={'status':'proved','sector':'floor','side':'zero','method':'half_open_floor_sector_identically_zero','C_value_upper':'0','C_sigma_derivative_upper':'0','coverage_hash':h(cov),'normalization_hash':h(norm)}
